...
export function Header({ activeView, onViewChange }: HeaderProps) {
  return (
    <header className="fixed top-0 left-0 right-0 z-50 flex items-center justify-center px-8 py-4 bg-background/95 backdrop-blur-md border-b border-border/50">
